...
<script type="text/javascript">
	$(function() {
		jQuery("#serverLog").jqGrid(
				{
					...
					colModel : [ {
						...
						sorttype : function(cell,obj){
							if(cell.indexOf('MB')>0){
								cell=cell.substr(0,cell.length-2);
								return cell*1024*1024;
							}else if(cell.indexOf('KB')>0){
								cell=cell.substr(0,cell.length-2);
								return cell*1024;
							}else{
		...
		$("#download").click(function(){
			...
			$("#download2").attr("href","download?filename="+rowData.name);
...
<body>
	<div id="buttons">
		...
		<div style='display:none'><a href="javascript:void(0)" id="download2" >link</a></div>
	</div>
