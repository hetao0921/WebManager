...
<script type="text/javascript">
	$(function() {
		...
		function getCurrentTime() {
			var time = $(".ui-datepicker-current").click();
			return time;
		}
		...
		$(".searchButtonClass").css("margin-bottom","0");
...
.filtertable label{margin-left:25px;}
</style>
</head>
