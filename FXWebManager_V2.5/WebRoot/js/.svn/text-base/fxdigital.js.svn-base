...
function createMessageDialog(message,type){
	...
	if(type == "" || type == null){
		...
		$("<p><span class=\"ui-icon ui-icon-"+type+"\" style=\"float:left; margin:0 7px 7px 0;\"></span><span>" + message + "</span></p>").appendTo($("#dialog-message"));
	}
...
function createConfirmDialog(message){
	...
	$("<p><span class=\"ui-icon ui-icon-alert\" style=\"float:left; margin:0 7px 7px 0;\"></span><span>" + message + "</span></p>").appendTo($("#dialog-confirm"));
