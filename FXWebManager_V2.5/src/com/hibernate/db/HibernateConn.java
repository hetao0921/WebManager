...
public class HibernateConn {
	...
	public HibernateConn(Database db) {
		if(Database.jms_client == db){
			session = HibernateJmsClientSessionFactory.getSession();
		}else if(Database.nvmp == db){
    ...
    public String[][] toArray(List<HashMap<String, String>> list){
