...
import com.fxdigital.db.dao.SyncUpnetworkinfoDao;
...
//		syncServersDao.insert(null, syncServer);
	...
	public boolean changeSubStatus(String id,String status){
	   ...
	   public int saveUpNetWork(SyncUpnetworkinfo syncUpnetworkinfo){
		 syncUpnetworkinfoDao.deleteRecord();
		 return  syncUpnetworkinfoDao.save(syncUpnetworkinfo);
		   
		   
	   }
	
	   public SyncUpnetworkinfo getNetUpWorkInfo(){
		   return  syncUpnetworkinfoDao.query();
		   
	   }
	

	   public int deleteUpNetWork(){
		   return syncUpnetworkinfoDao.deleteRecord();
	   }
