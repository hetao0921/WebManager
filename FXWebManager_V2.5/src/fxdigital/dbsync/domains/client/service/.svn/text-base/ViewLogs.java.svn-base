...
public class ViewLogs {
	 ...
	 * @return
	 */
	public List<HashMap<String, String>> getSearchLogs(String centerid,String beginTime,String endTime,String uuid,String sessionid){
		List<HashMap<String, String>> logList;
		try {
			logList = DataOperateRecordDao.getInstance().getSearchLogRecord(centerid,beginTime,endTime);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			logger.info("getLoadVersionInfo error"+e);
			e.printStackTrace();
