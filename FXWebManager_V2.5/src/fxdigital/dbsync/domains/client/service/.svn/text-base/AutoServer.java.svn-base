...
//	@PostConstruct
	public void afterInit() {
		...
		String autodownDeviceType = ConfigUtil.getString("autodown.devicetype");
		String deviceType = DeviceImpl.getDeviceInstance().isLicense();
		logger.info("autodownDeviceType " + autodownDeviceType + " deviceType "
				+ deviceType);
		logger.info("autodowndelay" + autodowndelay);
		logger.info("autodowninteval" + autodowninteval);
//		if (null != deviceType && autodownDeviceType.contains(deviceType)) {
